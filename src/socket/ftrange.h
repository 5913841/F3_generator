...
void init_ft_range(FTRange* ft_range)
{
...
void set_start_ft(Socket* socket, const FTRange& ft_range)
{
...
void increase_ft(Socket* socket, const FTRange& ft_range)
{
...
void set_by_range_idx_ft(Socket* socket, const FTRange& ft_range, int idx)
{
    int dst_port_idx = idx % ft_range.dst_port_num;
    int dst_ip_idx = (idx / ft_range.dst_port_num) % ft_range.dst_ip_num;
    int src_port_idx = (idx / (ft_range.dst_port_num * ft_range.dst_ip_num)) % ft_range.src_port_num;
    int src_ip_idx = idx / (ft_range.dst_port_num * ft_range.dst_ip_num * ft_range.src_port_num);
